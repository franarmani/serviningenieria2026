...
const Services = () => {
  ...
  const activeDivisions = [
    ...
    },
    {
      ...
      capabilities: language === 'es' ? ['Auditorías Res. 785/05 y 277/25', 'MFL, LFET, UT, PAUT', 'Acceso por cuerda AATTVAC'] : ['Res. 785/05 & 277/25 Audits', 'MFL, LFET, UT, PAUT', 'AATTVAC rope access']
    }
  ];
