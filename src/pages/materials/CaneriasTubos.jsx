      ...
      <section className="relative py-12 sm:py-16 lg:py-24 bg-corporate-red overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            <Link 
              to={`/contact?subject=${encodeURIComponent(language === 'es' ? 'Solicitud de cotización: cañerías y tubos certificados' : 'Quote request: certified pipes and tubes')}#formulario`}
