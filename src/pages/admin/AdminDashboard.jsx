    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-8 sm:mb-10">
          ...
          {/* Publicadas */}
          <div className="group bg-gradient-to-br from-[#1a1a1a] to-[#141414] rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-gray-800 hover:border-green-600/50 transition-all duration-300 hover:shadow-2xl hover:shadow-green-600/10">
            <div className="flex items-start justify-between mb-4">
              <div className="bg-green-600/10 rounded-xl p-3 group-hover:bg-green-600/20 transition-colors">
                <svg className="w-7 h-7 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
              </div>
              <span className="text-xs font-bold text-gray-600 uppercase tracking-wider bg-[#0a0a0a] px-3 py-1 rounded-full">Activas</span>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-black text-green-500 mb-1">
                {newsList.filter(n => n.status === 'published').length}
              </p>
              <p className="text-xs sm:text-sm text-gray-500 font-medium">Publicaciones visibles</p>
            </div>
          </div>

          {/* Borradores */}
          <div className="group bg-gradient-to-br from-[#1a1a1a] to-[#141414] rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-gray-800 hover:border-yellow-600/50 transition-all duration-300 hover:shadow-2xl hover:shadow-yellow-600/10">
            <div className="flex items-start justify-between mb-4">
              <div className="bg-yellow-600/10 rounded-xl p-3 group-hover:bg-yellow-600/20 transition-colors">
                <svg className="w-7 h-7 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                </svg>
              </div>
              <span className="text-xs font-bold text-gray-600 uppercase tracking-wider bg-[#0a0a0a] px-3 py-1 rounded-full">Pendientes</span>
            </div>
            <div>
