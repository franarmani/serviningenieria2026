      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-corporate-dark via-slate-900 to-corporate-dark">
          ...
          <div className="absolute inset-0 opacity-30">
            <img 
              ...
              alt={language === 'es' ? 'Ingeniería Civil' : 'Civil Engineering'} 
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-16 sm:py-20">
          ...
          <div className="mb-6 sm:mb-8 animate-fade-in-up">
            <div className="inline-flex items-center bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 sm:px-6 py-2 mb-6 sm:mb-8">
              ...
              <span className="text-white/80 text-xs sm:text-xs sm:text-sm font-medium tracking-wider uppercase" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
                {language === 'es' ? 'Ingeniería especializada' : 'Specialized Engineering'}
              </span>
            </div>
          </div>
          ...
          <p className="text-base lg:text-sm sm:text-base md:text-lg text-white/70 mb-16 max-w-4xl mx-auto leading-relaxed animate-fade-in-up-delay-2" style={{ 
            ...
            {language === 'es' 
              ? <>Diseño estructural computacional, <strong className="text-white font-normal">infraestructura vial estratégica</strong>, sistemas hidráulicos especializados y <strong className="text-white font-normal">planificación urbana integral</strong> con tecnologías de vanguardia.</>
              : <>Computational structural design, <strong className="text-white font-normal">strategic road infrastructure</strong>, specialized hydraulic systems and <strong className="text-white font-normal">comprehensive urban planning</strong> with cutting-edge technologies.</>
            }
          </p>
          ...
          {/* Minimal Stats - High Status */}
          <div className="grid grid-cols-3 gap-16 max-w-2xl mx-auto">
            <div className="text-center">
              <div className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2 tracking-tight">46+</div>
              <div className="text-white/60 text-xs sm:text-sm font-light uppercase tracking-widest">{language === 'es' ? 'Años' : 'Years'}</div>
            </div>
            <div className="text-center">
              <div className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2 tracking-tight">400+</div>
              <div className="text-white/60 text-xs sm:text-sm font-light uppercase tracking-widest">{language === 'es' ? 'Clientes' : 'Clients'}</div>
            </div>
            <div className="text-center">
              <div className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2 tracking-tight">100%</div>
              <div className="text-white/60 text-xs sm:text-sm font-light uppercase tracking-widest">{language === 'es' ? 'Nacional' : 'Nationwide'}</div>
            </div>
          </div>
        </div>
