...
const MaterialesLanding = () => {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="group h-full">
              ...
              >
                <div className="aspect-[4/3] bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden flex-shrink-0">
                  <img 
                    src="/external/steel_globe_valve_closeup_175966898764.webp" 
            ...
            <div className="group h-full">
              ...
              >
                <div className="aspect-[4/3] bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden flex-shrink-0">
                  <img 
                    src="/external/omega-hotspots_86c5a46c.webp" 
            ...
            <div className="group h-full">
              ...
              >
                <div className="aspect-[4/3] bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden flex-shrink-0">
                  <img 
                    src="/external/rightFalkCT-hotspots_df9cbeb7.webp" 
            ...
            <div className="group h-full">
              ...
              >
                <div className="aspect-[4/3] bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden flex-shrink-0">
                  <img 
                    src="/external/industrial_pipes_valve_177351745876.webp" 
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-14 lg:py-16" style={{background: 'linear-gradient(135deg, #E00000 0%, #C80000 100%)'}}>
