    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[65vh] sm:min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="/external/rightFalkCT-hotspots_2a992995.webp" 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-corporate-red via-red-800 to-red-900 rounded-3xl p-8 sm:p-10 lg:p-14 text-center shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <a 
                  href="#scroll-content" 
                  className="btn-primary-light px-8 py-4"
                >
                ...
                <div className="space-y-3 sm:space-y-4">
                  {(language === 'es' ? [
                    ...
                    <div key={index} className="flex items-start space-x-2.5 sm:space-x-3">
                      <div className="flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center mt-0.5 bg-corporate-red">
              ...
              <div>
                <div className="relative pb-6 pr-6 sm:pb-0 sm:pr-0">
                  <div className="aspect-[4/3] sm:aspect-square bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl overflow-hidden shadow-lg">
                    <img 
                      src="/external/water_pump_system_161715509370.webp"
                ...
                <div className="p-6 sm:p-8">
                  <div className="space-y-4">
                    <div className="flex justify-between items-center py-3 border-b border-gray-100">
                      ...
                      <span className="font-bold text-corporate-red" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>25 HP - 400 HP</span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-gray-100">
                      ...
                      <span className="font-bold text-corporate-red" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>8:1 a 16:1</span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-gray-100">
                      <span className="font-semibold text-gray-700" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>Service Factor:</span>
                      <span className="font-bold text-corporate-red" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>{language === 'es' ? '2.0 estándar' : '2.0 standard'}</span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-gray-100">
                      ...
                      <span className="font-bold text-corporate-red" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>{language === 'es' ? 'Eje vertical / ángulo recto' : 'Vertical shaft / right angle'}</span>
                    </div>
                    <div className="flex justify-between items-center py-3">
                      ...
                      <span className="font-bold text-corporate-red" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>{language === 'es' ? '≥ 100.000 horas' : '≥ 100,000 hours'}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative pb-6 pr-6 sm:pb-0 sm:pr-0">
                  <div className="aspect-[4/3] sm:aspect-square bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl overflow-hidden shadow-xl">
                    <img 
                      src="/external/water_pump_industrial_161715509370.webp"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mt-12">
              ...
              >
                ...
                <span>{language === 'es' ? 'Ver acoplamientos Addax' : 'View Addax couplings'}</span>
              </Link>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
              ...
              <div className="group bg-white rounded-lg sm:rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 p-3 sm:p-5 lg:p-6 text-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-lg flex items-center justify-center mx-auto mb-2 sm:mb-3 lg:mb-4 group-hover:scale-105 transition-transform bg-corporate-red">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
                <Link 
                  to={`/contact?subject=${encodeURIComponent(language === 'es' ? 'Cotización técnica: Reductor Falk CT-Series (torre de enfriamiento)' : 'Technical quote: Falk CT-Series gearbox (cooling tower)')}#formulario`}
