  ...
  const serviciosRevestimiento = language === 'es' ? [
    {
      ...
      imagen: "/external/sandblasting_sparks_175674258871.webp"
    },
    {
      ...
      imagen: "/external/industrial_factory_general_174894646985.webp"
    }
  ] : [
    {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[65vh] sm:min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="/external/hot_steel_bars_processed_174894646996.webp" 
      ...
      <section className="min-h-[60vh] flex items-center justify-center bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to={`/contact?subject=${encodeURIComponent(language === 'es' ? 'Interés: División de Revestimiento Industrial (próximamente)' : 'Interest: Industrial Coating Division (coming soon)')}#formulario`}
