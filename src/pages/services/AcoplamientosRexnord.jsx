  ...
  const acoplamientosRexnord = [
    {
      ...
      imagen: "/acoplamientos/omega-elastomeric.webp",
    ...
    },
    {
      ...
      imagen: "/acoplamientos/viva-elastomeric.webp",
      caracteristicas: language === 'es' 
    ...
    },
    {
      ...
      imagen: "/acoplamientos/composite-disc.webp",
      caracteristicas: language === 'es' 
    ...
    },
    {
      ...
      imagen: "/acoplamientos/thomas-xtsr.webp",
      caracteristicas: language === 'es' 
    ...
    },
    {
      ...
      imagen: "/external/img_euroflexDiscCoupling_thumbnail_5e582ad3.webp",
      caracteristicas: language === 'es' 
    ...
    },
    {
      ...
      imagen: "/external/Elastomeric_50fcb04a.webp",
      caracteristicas: language === 'es' 
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[65vh] sm:min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="/external/omega-hotspots_734e3818.webp" 
            ...
            <div className="space-y-12 sm:space-y-16">
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-0">
                  ...
                  <div className="grid grid-cols-2 grid-rows-2 gap-1">
                    <img src="/external/mining_steel_pipes_170924459618.webp" alt="Molino horizontal minería" className="w-full h-40 sm:h-48 object-cover col-span-2" />
                    <img src="/external/industrial_conveyor_belt_175697358484.webp" alt="Chancador minero" className="w-full h-32 sm:h-40 object-cover" />
                    <img src="/external/construction_cranes_machinery_176189605758.webp" alt="Transporte minero" className="w-full h-32 sm:h-40 object-cover" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-0">
                  <div className="grid grid-cols-2 grid-rows-2 gap-1 order-2 lg:order-1">
                    <img src="/external/01-types-of-pumps-in-the-oil-and-gas-industry_4ba9e35c.webp" alt="Bombas oil & gas" className="w-full h-40 sm:h-48 object-cover col-span-2" />
                    <img src="/external/oil_gas_pipes_valves_177351745876.webp" alt="Separador vertical" className="w-full h-32 sm:h-40 object-cover" />
                    <img src="/external/gas_meter_mounted_wall_176088681058.webp" alt='Skid de bombas industriales' className="w-full h-32 sm:h-40 object-cover" />
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-0">
                  ...
                  <div className="grid grid-cols-2 grid-rows-2 gap-1">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/KilnBZ.JPG/1200px-KilnBZ.Jwebp" alt="Horno rotatorio cemento" className="w-full h-40 sm:h-48 object-cover col-span-2" />
                    <img src="/external/cement_plant_factory_172891972346.webp" alt="Molino cemento" className="w-full h-32 sm:h-40 object-cover" />
                    <img src="/external/cement_plant_industrial_172891972346.webp" alt="Ventilador industrial" className="w-full h-32 sm:h-40 object-cover" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-0">
                  <div className="grid grid-cols-2 grid-rows-2 gap-1 order-2 lg:order-1">
                    <img src="/external/molten_steel_rods_factory_174894646985.webp" alt="Laminador siderúrgico" className="w-full h-40 sm:h-48 object-cover col-span-2" />
                    <img src="/external/crane_lifting_warehouse_173058447554.webp" alt="Grúa siderurgia" className="w-full h-32 sm:h-40 object-cover" />
                    <img src="/external/hot_steel_bars_processed2_174894646996.webp" alt="Colada continua" className="w-full h-32 sm:h-40 object-cover" />
                  </div>
                  <div className="p-6 sm:p-8 lg:p-10 flex flex-col justify-center order-1 lg:order-2">
                    <h4 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-0">
                  ...
                  <div className="grid grid-cols-2 grid-rows-2 gap-1">
                    <img src="/external/paper_mill_factory_174894646996.webp" alt="Planta pulpa papel" className="w-full h-40 sm:h-48 object-cover col-span-2" />
                    <img src="/external/paper_machine_steel_174894646985.webp" alt="Refinador papel" className="w-full h-32 sm:h-40 object-cover" />
                    <img src="/external/ahlstar_end_suction_single_stage_process_pump_in_paper_mill_be8a274a.webp" alt="Bomba proceso papel" className="w-full h-32 sm:h-40 object-cover" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-0">
                  <div className="grid grid-cols-2 grid-rows-2 gap-1 order-2 lg:order-1">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/7/74/Tyssedal_Interior.Jwebp" alt="Sala turbinas" className="w-full h-40 sm:h-48 object-cover col-span-2" />
                    <img src="/external/industrial_machinery_176969583219.webp" alt="Generador eléctrico" className="w-full h-32 sm:h-40 object-cover" />
