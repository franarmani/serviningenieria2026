          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div className="flex items-start gap-6">
              <div className="text-left md:text-right">
                ...
                <p className="mt-3 text-[10px] sm:text-xs text-gray-500" style={{ fontFamily: 'Inter, system-ui, sans-serif', fontWeight: '300' }}>
                  {language === 'es' ? 'Sitio web diseñado y desarrollado por ' : 'Website designed and developed by '}
                  <a
                    href="https://portfoliofrandev.vercel.app/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-medium text-gray-300 hover:text-corporate-red transition-colors"
                  >
                    FranDev
                  </a>
                </p>
