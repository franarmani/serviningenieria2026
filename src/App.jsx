...
const NotFound = () => {
  return (
    <section className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-white text-gray-950">
      <div className="text-center max-w-2xl mx-auto px-4 sm:px-6">
        <div className="text-[10rem] sm:text-[12rem] font-black text-corporate-red leading-none mb-4 select-none">
          404
        </div>
        <div className="h-px w-16 bg-corporate-red mx-auto mb-8" />
        ...
        <p className="text-gray-500 text-base sm:text-lg leading-relaxed mb-10 max-w-lg mx-auto">
          La página que estás buscando no existe, fue movida o está temporalmente fuera de servicio.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="/" className="inline-flex items-center gap-2 bg-corporate-red hover:bg-red-700 text-white font-semibold px-7 py-4 transition-colors">
            Volver al inicio
          </a>
          <a href="/divisiones" className="inline-flex items-center gap-2 border border-gray-300 hover:border-gray-950 text-gray-700 hover:text-gray-950 font-semibold px-7 py-4 transition-colors">
            Ver divisiones
          </a>
        </div>
      </div>
